...
Examples live in [`src/pydgens/examples/`](https://github.com/mit-ll/pydgens/tree/main/src/pydgens/examples/). These scripts are useful both as smoke tests and as starting points for new game formulations.
...
| [IR Lady-Bandit-Guard](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_lady_bandit_guard.py) | `python -m pydgens.examples.ir_lady_bandit_guard` | `LQ` -> feedback Nash equilibrium | IR | Advanced three-player LQ example built from cost matrices. |
| [IR Constrained Integrators](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_constrained_integrators.py) | `python -m pydgens.examples.ir_constrained_integrators` | `AL` -> local open-loop Nash equilibrium | IR | Advanced AL companion to `constrained_integrators.py`. |
| [IR Nonlinear Lady-Bandit-Guard (Diagnostic)](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_lady_bandit_guard_nonlinear.py) | `python -m pydgens.examples.ir_lady_bandit_guard_nonlinear` | `iLQ` -> local feedback Nash equilibrium attempt | IR | Runs to completion but may report non-convergence. |
| [IR Constrained Double-Integrator (Diagnostic)](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_constrained_double_integrator_diagnostic.py) | `python -m pydgens.examples.ir_constrained_double_integrator_diagnostic` | `AL` -> local open-loop Nash equilibrium attempt | IR | Prints a problem summary by default; use `--run-solver` to exercise the known-problematic solve path. |
...
Source: [`src/pydgens/examples/tug_o_war.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/tug_o_war.py)
...
Source: [`src/pydgens/examples/satellite_lady_bandit_guard.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/satellite_lady_bandit_guard.py)
...
Source: [`src/pydgens/examples/unicycle.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/unicycle.py)
...
Source: [`src/pydgens/examples/multi_car_intersection.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/multi_car_intersection.py)
...
Source: [`src/pydgens/examples/constrained_integrators.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/constrained_integrators.py)
...
Source: [`src/pydgens/examples/ir_unicycle.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_unicycle.py)
...
Source: [`src/pydgens/examples/ir_lady_bandit_guard.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_lady_bandit_guard.py)
...
Source: [`src/pydgens/examples/ir_constrained_integrators.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_constrained_integrators.py)
...
Source: [`src/pydgens/examples/ir_lady_bandit_guard_nonlinear.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_lady_bandit_guard_nonlinear.py)
...
Source: [`src/pydgens/examples/ir_constrained_double_integrator_diagnostic.py`](https://github.com/mit-ll/pydgens/blob/main/src/pydgens/examples/ir_constrained_double_integrator_diagnostic.py)
